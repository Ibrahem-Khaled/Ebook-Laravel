                        ...
                        <div class="card-body pb-2">
                                    ...
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        @if(count($errors->get('category_name')) >= 1)
                                            <input name="category_name" id="category_name" class="form-control"
                                                   placeholder="اسم الفئة" aria-label="Full Name"
                                                   type="text"
                            ...
                            <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                ...
                                @else
                                    <textarea name="category_description" class="form-control" id="category_description"
                                              rows="6"
                                              placeholder="وصف موجز للفئة">{{app('request')->old('category_description', null)}}</textarea>
                                @endif
                            </div>
                            <x-input-error class="text-danger"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col" style="min-width: 250px">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text mb-4">قم بتحميل الصورة بتنسيق .jpg ، تأكد من أن الصورة تلبي نسبة العرض إلى الارتفاع 5: 6 لضمان عرض مثالي.
                                                </p>
                                                <x-input-error class="text-danger"
