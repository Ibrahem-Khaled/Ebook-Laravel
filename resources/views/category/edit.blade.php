                            ...
                            <div class="card-body pb-2">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group input-group-static mb-4">
                                            ...
                                            @if (count($errors->get('category_name')) >= 1)
                                                <input value="{{ $category->category_name }}" name="category_name"
                                                    id="category_name" class="form-control" placeholder="اسم الفئة"
                                        ...
                                        <x-input-error class="text-danger" :messages="$errors->get('category_name')"></x-input-error>
                                    </div>
                                ...
                                <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                    ...
                                    @if (count($errors->get('category_description')) >= 1)
                                        <textarea name="category_description" class="form-control" id="category_description" rows="6"
                                            placeholder="وصف موجز للفئة" style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;">{{ $category->category_description }}</textarea>
                                    @else
                                        <textarea name="category_description" class="form-control" id="category_description" rows="6"
                                            placeholder="وصف موجز للفئة">{{ $category->category_description }}</textarea>
                                    @endif
                                </div>
                                <x-input-error class="text-danger" :messages="$errors->get('category_description')"></x-input-error>
                                    ...
                                    <div class="card mt-5" <?php if (count($errors->get('category_image')) >= 1) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col" style="min-width: 250px">
                                                <div class="card-body">
                                                    <h4 class="font-weight-normal mt-3">الصورة</h4>
                                                    <p class="card-text mb-4">قم بتحميل الصورة بتنسيق .jpg، تأكد من أن
                                                        الصورة تلبي نسبة العرض إلى الارتفاع 5:6 لضمان عرض مثالي.
                                                    </p>
                                                    ...
                                                    <div class="row mt-5">
                                                        <div class="col-md-4">
                                                            ...
                                                            <a id="falseinput" class="btn btn-outline-warning">تحميل
                                                                الصورة</a>
                                                        </div>
                                                        <div class="col" style="align-self: center;">

                                                            <p id="selected_filename">لا يوجد ملف محدد</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="input-group input-group-static mb-4 mt-4">
                                    <input id="fileinput" name="category_image" type="file"
