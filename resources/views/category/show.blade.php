                        ...
                        <div class="card-body pb-2">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="display-4 text-md">تم إنشاؤها في {{ $category->created_at }} وتم تحديثها
                                        للمرة الأخيرة في {{ $category->updated_at }}</div><br>
                                                    ...
                                                    @foreach ($category->subcategories as $subcategory)
                                                        <li
                                                            ...
                                                            <span data-bs-toggle="tooltip" data-bs-placement="left"
                                                                title="هذه الفئة الفرعية تحتوي على {{ count($subcategory->books) }} كتب"
                                                                class="badge bg-gradient-warning">{{ count($subcategory->books) }}</span>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            @else
                                                <p class="display-4" style="font-size: x-large">لا توجد فئات فرعية لهذه
                                                    الفئة.</p>
                                            @endif
                                        </div>
                                ...
                                <div class="col-lg-6 text-center">
                                    <img id="category_img" class="border-radius-lg w-65"
                                        src="{{ asset($category->category_image_url) }}" alt="صورة الفئة">
                                </div>
                            </div>
