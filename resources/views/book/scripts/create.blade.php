        ...
        $.ajax({
            ...
            .done(function(authors) {
                ...
                authors.forEach(function(author) {
                    ...
                    resultsList +=
                        `<li style="cursor: default;"><a class='dropdown-item' data-author-id="${author.id}" data-author-name="${author.author_name}">${author.author_name}</a></li>`;
                });
        ...
        $.ajax({
            ...
            .done(function(publishers) {
                ...
                publishers.forEach(function(publisher) {
                    ...
                    resultsList +=
                        `<li style="cursor: default;"><a class='dropdown-item' data-publisher-id="${publisher.id}" data-publisher-name="${publisher.publisher_name}">${publisher.publisher_name}</a></li>`;
                });
