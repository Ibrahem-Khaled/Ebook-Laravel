...
<body>
    ...
    <div class="card card-body shadow-2xl shadow-dark mx-4 mx-md-5 mx-lg-10 mt-9">
        <div class="row mt-4">
            <div class="col-md-3">
                <a class="btn bg-white mb-0 mt-lg-auto w-100" onclick="window.history.back()"
                ...
                <div class="row flex-row">
                    ...
                    <div class="col-lg-7">
                        <div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-3">
                                    <a class="btn bg-gradient-faded-white mb-0 mt-lg-auto w-100"
                                        href="{{ route('home') }}" class="btn bg-gradient-faded-secondary"
                                        style="max-width: 233px; width: -webkit-fill-available;">العودة
                                    </a>
                                </div>

                                <div class="col-md-3">
                                    <button class="btn bg-gradient-warning disabled mb-0 mt-lg-auto w-100"
                                        type="button" name="button">شراء <svg style="margin-left: 1rem"
