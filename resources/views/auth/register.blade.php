...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3">
    <div class="container">
        <a class="navbar-brand  text-dark " href="{{ route('home') }}" rel="tooltip"
           title="تصميم وتشفير بواسطة ديبي ب." data-placement="bottom">
                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-warning shadow-warning border-radius-lg py-3 pe-1">
                            <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">سجل</h4>
                            <br><br>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" role="form" class="text-start">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn bg-gradient-warning w-100 my-1">متابعة</button>
                            </div>
                            <div class="text-center">
                                <a href="{{ route('login.google') }}" class="btn bg-outline-warning w-100 my-1">متابعة
                                    مع جوجل
                            ...
                            <p class="mt-4 text-sm text-center">
                                هل لديك حساب؟ <a href="{{route('login')}}" class="text-warning">تسجيل الدخول</a>
                            </p>
                        </form>
                    </div>
                </div>
...
<!--   العناصر الأساسية لجافا سكريبت   -->
<script src="{{asset('js/core/popper.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/core/bootstrap.min.js')}}" type="text/javascript"></script>
<script src="{{asset('js/plugins/perfect-scrollbar.min.js')}}"></script>
<!-- مركز التحكم لـ Material UI Kit: تأثيرات البارالاكس، النصوص للصفحات المثالية الخ. -->
