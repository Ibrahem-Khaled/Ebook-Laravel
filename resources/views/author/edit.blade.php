    ...
    <div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
        ...
        <div class="container">
            <div class="section text-left my-4">
                ...
                <h2 class="title">تحرير المؤلف</h2>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group input-group-static mb-4">
                                            ...
                                            @if (count($errors->get('author_name')) >= 1)
                                                <input value="{{ $author->author_name }}" name="author_name"
                                                    id="author_name" class="form-control" placeholder="اسم المؤلف"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group input-group-static mb-4">
                                                <label>الوصف</label>
                                                <textarea name="desc" id="desc" class="form-control" placeholder="وصف المؤلف" aria-label="Author Description">{{ $author->desc }}</textarea>
                                            </div>
