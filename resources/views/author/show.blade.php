                        ...
                        <div class="card-body pb-2">
                            <div class="col-lg-12">
                                ...
                                <ul>
                                    ...
                                    <li>Telegram: {{ $author->telegram }}</li>
                                    <li>WhatsApp: {{ $author->whatsapp }}</li>
                                    <li>Instagram: {{ $author->instagram }}</li>
                                </ul>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-12 text-start">
                                    <a href="{{ route('author.index') }}"
                                        class="btn bg-gradient-danger mt-3 mb-0">العودة</a>
                                </div>
                            </div>
                        </div>
                    </div>
