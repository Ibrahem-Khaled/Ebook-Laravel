    ...
    <div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
        ...
        <div class="container">
            <div class="section text-left my-4">
                ...
                <h2 class="title">عرض الفئة الفرعية</h2>
                    ...
                    <div class="card d-flex justify-content-center p-4 shadow-lg">
                        ...
                        <div class="card-body pb-2">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col">
                                        <h2 style="width: fit-content"> {{ $category->category_name }} > <span
                                                style="font-weight: 300;">{{ $subcategory->subcategory_name }} </span>
                                        </h2>
                                        <div class="display-4 text-md">تم إنشاؤها في {{ $subcategory->created_at }}
                                            وتحديثها لآخر مرة في {{ $subcategory->updated_at }}</div>
                                    </div>
