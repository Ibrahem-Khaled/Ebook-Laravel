...
<div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
    ...
    <div class="container">
        <div class="section text-left my-4">
            ...
            <h2 class="title">إنشاء فئة فرعية</h2>
                                ...
                                <div class="input-group input-group-static mb-4 mt-4">
                                    ...
                                    @if(count($errors->get('category_id')) >= 1)
                                        <select name="category_id" id="category_id" class="form-control"
                                            ...
                                            <option selected disabled hidden value="">اختر فئة</option>
                            ...
                            <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                ...
                                @if(count($errors->get('subcategory_description')) >= 1)
                                    <textarea name="subcategory_description" class="form-control"
                                              ...
                                              placeholder="وصف مختصر للفئة الفرعية" style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;">{{app('request')->old('subcategory_description', null)}}</textarea>
                                @else
                                    <textarea name="subcategory_description" class="form-control"
                                              id="subcategory_description" rows="6"
                                              placeholder="وصف مختصر للفئة الفرعية">{{app('request')->old('subcategory_description', null)}}</textarea>
                                @endif
...
<!-- مركز التحكم لمواد الواجهة: تأثيرات البارالاكس، النصوص لصفحات المثال الخ. -->
