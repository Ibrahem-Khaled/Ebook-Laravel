                ...
                <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" style="border-radius: 10px">
                        <div class="carousel-item active" style="text-align: -webkit-center;">
                            <img class="desktopBanner w-100" src="{{ asset('img/bg6.jpg') }}" alt="seven slide">
                            <img class="phoneBanner w-100" src="{{ asset('img/bgm6.jpg') }}" alt="six slide">
                        </div>
                        <div class="carousel-item" style="text-align: -webkit-center;">
                            <img class="desktopBanner w-100" src="{{ asset('img/bg2.jpg') }}" alt="Third slide">
                            <img class="phoneBanner w-100" src="{{ asset('img/bgm2.jpg') }}" alt="Third slide">
                        </div>
                        <div class="carousel-item" style="text-align: -webkit-center;">
                            <img class="desktopBanner w-100" src="{{ asset('img/bg3.jpg') }}" alt="fourth slide">
                            <img class="phoneBanner w-100" src="{{ asset('img/bgm3.jpg') }}" alt="fourth slide">
                        </div>

                        <div class="carousel-item" style="text-align: -webkit-center;">
                            <img class="desktopBanner w-100" src="{{ asset('img/bg5.jpg') }}" alt="seven slide">
                            <img class="phoneBanner w-100" src="{{ asset('img/bgm5.jpg') }}" alt="six slide">
                        </div>
                                    ...
                                    <div class="col-md-5 ms-lg-auto">
                                        <div class="p-3">
                                            <img class="w-100 border-radius-xl h-100 fadeIn2 fadeInBottom"
                                                src="{{ asset($categories[0]->category_image_url) }}" alt=""
                                                loading="eager">
                                        </div>
                                    </div>
                                    <div class="col-md-5 me-lg-auto position-relative">
                                        <h4
                                            class="opacity-7 text-uppercase font-weight-bolder text-xxl-start fadeIn4 fadeInBottom">
                                            {{ '1°' }}</h4>
                                ...
                                <div class="container">
                                    <div class="row align-items-center">
                                        <div class="col-md-5 ms-lg-auto">
                                            <div class="p-3">
                                                <img class="w-100 border-radius-xl h-100 fadeIn2 fadeInBottom"
                                                    src="{{ $categories[$i - 1]->category_image_url }}" alt=""
                                                    loading="eager">
                                            </div>
                                        </div>
                                        <div class="col-md-5 me-lg-auto position-relative">
                ...
                <div class="container-fluid">
                    <div class="row mt-4">
                        <div class="col-lg-6" style="margin-left: 10%;max-width: 600px;">
                            ...
                            <p class="mb-2" style="font-size: 20px">somos un espacio acogedor donde las historias
                                cobran
                            ...
                            <ul class="m-lg-2 m-auto" style="font-size: 20px">
                                <li class="mb-2" style="font-size: 20px">Cuidada selección: <p
                                ...
                                <li class="mb-2" style="font-size: 20px">Asesoramiento personalizado: <p
                                        ...
                                        lectura
                                        está
                                        aquí para ofrecerte recomendaciones personalizadas y guiar tu búsqueda.</p>
                                </li>
                            </ul>
                            <br>
                        ...
                        <div class="col-lg-6 text-center">
                            <img style="margin-left: 4rem" class="desktopBanner border-radius-lg shadow-lg w-50"
                                src="{{ asset('img/bg13.jpg') }}" alt="">
                            <img class="phoneBanner border-radius-lg shadow-lg w-100"
                                src="{{ asset('img/bg13.jpg') }}" alt="">
                    ...
                    <div class="row flex mx-0 mt-4" style="justify-content: center">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="row" style="align-items: center;">
                                ...
                                <div class="col-lg-6">
                                    <p style="font-size: 20px">No solo ofrecemos libros, también disponemos de una
                                        amplia
                                        gama
                                        de
                                        productos
