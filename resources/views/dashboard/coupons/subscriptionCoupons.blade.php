...
@section('content')
    <div class="container mt-5">
        <h1 class="text-center mb-4">كوبونات الاشتراك</h1>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p><strong>اسم الاشتراك:</strong> {{ $subscription->subscription_name ?? '---' }}</p>
                <!-- يمكنك إضافة تفاصيل أخرى للاشتراك هنا -->
            </div>
        </div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center">لا توجد كوبونات مرتبطة بهذا الاشتراك.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
