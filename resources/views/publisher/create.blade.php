...
<body>
    ...
    <div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
        ...
        <div class="container">
            <div class="section text-left my-4">
                ...
                <h2 class="title">إنشاء الناشر</h2>
                                ...
                                <div class="row">
                                        ...
                                        <div class="input-group input-group-static mb-4">
                                            ...
                                            @if (count($errors->get('publisher_name')) >= 1)
                                                <input name="publisher_name" id="publisher_name" class="form-control"
                                                    placeholder="اسم الناشر" aria-label="Full Name" type="text"
                                                    style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;"
                                                    value="{{ app('request')->old('publisher_name', null) }}">
                                            @else
                                                <input name="publisher_name" id="publisher_name" class="form-control"
                                                    placeholder="اسم الناشر" aria-label="Full Name" type="text"
                                                    value="{{ app('request')->old('publisher_name', null) }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group input-group-static mb-4">
                                                <label>الوصف</label>
                                                <textarea name="desc" id="desc" class="form-control" placeholder="وصف المؤلف" aria-label="Author Description">{{ app('request')->old('desc', null) }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-static mb-4">
                                                ...
                                                <input name="telegram" id="telegram" class="form-control"
                                                    ...
                                                    value="{{ app('request')->old('telegram', null) }}">
                                            </div>
                                            <!-- Add any necessary validation error display here -->
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-static mb-4">
                                                ...
                                                <input name="whatsapp" id="whatsapp" class="form-control"
                                                    ...
                                                    value="{{ app('request')->old('whatsapp', null) }}">
                                            </div>
                                            <!-- Add any necessary validation error display here -->
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group input-group-static mb-4">
                                                ...
                                                <input name="instagram" id="instagram" class="form-control"
                                                    ...
                                                    value="{{ app('request')->old('instagram', null) }}">
                                            </div>
                                            <!-- Add any necessary validation error display here -->
                                        </div>
                                    </div>
    ...
    <!-- مركز التحكم لمجموعة المواد: تأثيرات التموج ، البرامج النصية للصفحات المثالية إلخ -->
